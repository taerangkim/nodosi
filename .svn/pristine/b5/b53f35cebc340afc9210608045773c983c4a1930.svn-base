...
<script>
    ...
    $( function() {
        ...
        $("#receiptdate").datepicker({
            ...
            if (year == "2023" &&  month == "01" && days == "22")    //특정일 예약 오픈
            {
                return [false];
            }
            if (year == "2023" && month == "01" && days == "23")    //특정일 예약 오픈
            {
                return [false];
            }
                if (year == "2023" && month == "01" && days == "24")    //특정일 예약 오픈
                {
                    return [false];
                }
            ...
            <div class="card-title" style="font-size: small  ">
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        -->
                            4. 예약 시 추가 요청 사항은 예약 후 댓글로 작성하여 주시기 바랍니다.<br>
                            5. 2023년 4월 24일 부터 현장 사정으로 인하여 직접 수령 예약을 제한 합니다.<br>
                            6. 퀵 서비스 및 고속버스 택배는 오전 발송이며 발송 시 연락 드립니다.<br>
                            7. 고속버스 택배 선택 시 수령지 고속버스 터미널을 기재 하여 주시기 바랍니다.<br>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <input type="hidden" name="orderidx" id="orderidx" value="@if (ordermode ==='up'){{$contentResult[0]['BIdx']}}@endif">
                        ...
                        <div class="form-group row" style="border-top: solid #9d9d9d 1px; padding-bottom: 5px;padding-top: 5px">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control form-control-sm" name="DepositorName" id="DepositorName" value="@if ($reservmode ==='up') {{$contentResult[0]['DepositorName']}} @endif" autocomplete="off" />
                            </div>
                        </div>
                        <div class="form-group row" style="border-top: solid #9d9d9d 1px; padding-bottom: 5px;padding-top: 5px">
                            <label class="col-sm-3 col-form-label">수령자</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control form-control-sm" name="ReceiptName" id="ReceiptName" value="@if ($reservmode ==='up') {{$contentResult[0]['TelNum']}} @endif" autocomplete="off" />
                            </div>
                        </div>
<!--
                        <div class="form-group row" style="border-top: solid #9d9d9d 1px; padding-bottom: 5px;padding-top: 5px">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control form-control-sm w-100" rows="10" style="max-width: 100%"  name="contents" id="contents" placeholder="20자 까지 입력 가능합니다." onkeyup="javascript:fn_TextAreaInputLimit();">@if ($reservmode ==='up'){{$contentResult[0]['Content']}}@endif</textarea>
                            </div>
                        </div>
-->
                        <div class="form-group row" style="border-top: solid #9d9d9d 1px; padding-bottom: 5px;padding-top: 5px">
...
<!-- 여기까지 -->
                        ...
                        <div class="row">
                            ...
                            <div class="col col-6">
                                <button type="button" class="form-control btn-success" class="btn" onclick="frmsubmit()">@if ($reservmode ==='up') 예약 수정 하기 @else 예약하기 @endif</button>
                            </div>
