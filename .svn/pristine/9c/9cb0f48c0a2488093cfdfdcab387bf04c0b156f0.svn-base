    ...
    <div class="col-xl-12 col-lg-7">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row row-cols-1 row-cols-sm-1 g-3">
                    ...
                    <div class="card shadow-sm">
                        ...
                        작성
                        <div class="font-semibold" style="text-align:right">
                        ...
                        <div class="card-body">
                            <div class="row mt-1">
                                <div class="col">
                                    <img src="/public/pds/2023/06/07/2632/20230607_171942.jpg" class="w-100">
                                </div>
                            </div>
                            <div class="row mt-1">
                                <div class="col" style="min-height:100px;max-height: 100px;overflow: hidden" id="board">
                                암컷 킹크랩<br>
                                ...
                                키로 15,000원 가격 대비하 괜찮다고 생각함<br>

                                살에 단맛은 없지만, 가격적으로 생각하면 괜찮음<br>

                                다소 첫구매자 나 기대감을 크게 가지시게 되면은 실망 할 수 있음.<br>

                                구매하여 먹으라고 한다면은 먹겠지만 기대는 안하고 사는걸 추천함<br>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col d-flex justify-content-between align-items-center mt-3">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-sm btn-outline-secondary"  onclick="" id="btn1">첨부사진보기</button>
                                        <button type="button" class="btn btn-sm btn-outline-secondary"  onclick="toogleTextView('board')">내용보기</button>
                                        <button type="button" class="btn btn-sm btn-outline-secondary">댓글 보기 +15</button>
                                    </div>
                                </div>
                            </div>
                    </div>
            ...
            <div class="card-footer py-3 ">
                <!-- ajax load 해서 추가로 더 붙이자 -->
                <a class="btn btn-sm btn-danger float-right" data-bs-toggle="modal" data-bs-target="#productStep1" data-toggle="modal" data-target=".productStep1">더보기</a>
            </div>
        </div>
    </div>
</div>
...
<script>
            ...
            function (data) {
                ...
                $.each(data, function (index, item) {
                    ...
                    if (item['ImageName'] == '') {
                        ...
                        imghtml = '<img src="' + item['path'] + '/' + item['ImageName'] + '" class="w-100" style="width: 138px; height: 138px">';
    ...
    function toogleTextView(obj)
    {
        ...
        {
            console.log("보이기");
            $obj.css( "max-height", "1000px" ).css( "overflow", "visible" )
            $btnobj.text ('내용닫기');
        }else
        {
            console.log("닫기");
            $obj.css( "max-height", "100px" ).css( "overflow", "hidden" );
            $btnobj.text ('내용보기');
        }
    }
</script>