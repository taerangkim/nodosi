<div class="container" style="min-height:600px;">
    ...
    <div class="row" style="height: 30px">
        <div class="col">
            <button type="submit" class="form-control" class="btn" style="font-size: small" onclick="$('#exampleModal1').modal('show');">1대1 문의 작성하기</button>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel" style="font-size: small">1대1 문의 작성</h5>
